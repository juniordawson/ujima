		...
		<div class="col-2-3">
			<div class="promo-box">
				...
				<div class="text">
					...
					<div class="categories mb-3">Listen live</div>

					<?php echo do_shortcode('[dj-widget title"Now On-Air" display_djs"1" show_link"1" default_name"RadioBot" time"12" show_sched"1"]'); ?>
